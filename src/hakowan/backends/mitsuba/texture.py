...
def generate_scalar_field_config(
    ...
    if is_primitive and is_color:
        # Primitive BSDF expansion converts these baked sRGB colors to Mitsuba's
        # linear RGB exactly once when constructing each material.
        ...
        return {"colors": mesh.attribute(name).data.tolist()}
    elif is_primitive:
