...
def generate_texture_config(
    mesh: lagrange.SurfaceMesh, tex: Texture, is_color: bool = False
) -> dict:
    ...
    """
    return _generate_texture_config(mesh, tex, is_color)
...
def generate_scalar_field_config(
    mesh: lagrange.SurfaceMesh, tex: ScalarField, is_color: bool
) -> dict:
...
def _generate_texture_config(
    mesh: lagrange.SurfaceMesh, tex: Texture, is_color: bool
) -> dict:
    match tex:
        case Uniform():
        ...
        case ScalarField():
            return generate_scalar_field_config(mesh, tex, is_color)
        case _:
